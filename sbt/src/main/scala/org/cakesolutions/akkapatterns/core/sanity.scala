...
import org.cakesolutions.akkapatterns.domain.{User, UserFormats}
...
trait SanityChecks extends TypedGraphDatabase with UserFormats with SprayJsonNodeMarshalling
  ...
  val RootUser = User(UUID.fromString("a3372060-2b3b-11e2-81c1-0800200c9a66"), "root", "").resetPassword(RootUserPassword)
